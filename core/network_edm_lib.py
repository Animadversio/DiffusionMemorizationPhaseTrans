    ...
    def __init__(self,
        ...
        for level, mult in reversed(list(enumerate(channel_mult))):
            ...
            if level == len(channel_mult) - 1:
                self.dec[f'{res}x{res}_in0'] = UNetBlock(in_channels=cout, out_channels=cout, attention=decoder_init_attn, **block_kwargs)
...
#----------------------------------------------------------------------------
# Simplified UNet ResNet architecture, no skip connections, no attention, only one resolution
